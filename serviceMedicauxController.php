...
<body>
    ...
    ?>
		...
		<form action="AthletesConfirmationController.php" method="POST">
			<div id="epreuveContainer" class="input-group mb-3">
  			  ...
  			  <select style="width:540px;height:40px" id="Services" name="Services[]">
		  	  	...
		  	  	<?php
						...
						$query = "SELECT * FROM 
									discipline AS  A, take care AS  S
									WHERE  S.service_id = S.id AND A.discipline_id ='$discipline' ;";
			...
			<button class="add_form_field" style="width: 500px;">Ajouter un autre service medical &nbsp; 
