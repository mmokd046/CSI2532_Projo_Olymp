...
<body>
	...
	$personne_id = intval($_POST['personne_id']);
	 ...
	 $personneQuery = "SELECT * FROM  personne 
    ...
    <form action="UpdateOfficielController.php" method="POST">
	...
	<div class = "wrapper">
  		<button style="margin-top: 20px;margin-left: 170" type="submit" class="btn btn-primary" class ="center">Update officiel</button>
	</div>
